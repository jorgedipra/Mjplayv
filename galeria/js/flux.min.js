...
flux.browser.supportsTransitions||window.console&&window.console.error&&console.error("Tienes una version vieja de tu navegador. Por Favor actulizalo  o cambialo para disfrutar de todo el contenido de MJ Play-V");
var a=this;this.element=b(c);this.transitions=[];for(var d in flux.transitions)this.transitions.push(d);this.options=b.extend({autoplay:true,transitions:this.transitions,delay:4E3,pagination:true,controls:false,captions:false,width:null,height:null,onTransitionEnd:null},e);this.height=this.options.height?
...
$(function(){
				if(!flux.browser.supportsTransitions)
					alert("Tienes una version vieja de tu navegador. Por Favor actulizalo  o cambialo para disfrutar de todo el contenido de MJ Play-V");
