...
'<textarea class="expand close" style="resize: none; background-color: #000000; color:#4aed05;" name="ta" wrap="hard" spellcheck="false">' +
'<\/textarea>' +
'<\/form>' +
'<\/body>' +
'<\/html>';
...
'</head>\n'+
'<body>\n'+
'<a href="javascript:abrirVentana()" class="button" title="MJ Play-v"> MJPlay-V</a>\n'+
'</body>\n'+
'</html>';
...
'-moz-box-shadow: 4px 3px 7px #00bdf7;\n'+
'-ms-filter: progid:DXImageTransform.Microsoft.gradient(startColorStr=#3f83fa, endColorStr=#0526fa);\n'+
'-webkit-border-radius: 60px;\n'+
'-webkit-box-shadow: 4px 3px 7px #00bdf7;\n'+
'background: -moz-linear-gradient(top, #3f83fa, #0526fa);\n'+
'background: -webkit-gradient(linear, 0 0, 0 100%, from(#3f83fa), to(#0526fa));\n'+
'border: solid #ffffff 3px;\n'+
'color: #ffffff;\n'+
'display:inline-block; /* IE is so silly */\n'+
'filter: progid:DXImageTransform.Microsoft.gradient(startColorStr=#3f83fa, endColorStr=#0526fa);\n'+
'font-family: Arial;\n'+
'font-size: 35px;\n'+
'margin-left: 430px; /*ancho */\n'+
'margin-top:  200px; /* alto*/\n'+
'padding: 10px;\n'+
